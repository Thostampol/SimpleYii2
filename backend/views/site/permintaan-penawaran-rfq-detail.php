...
$this->title = 'Detail Penawaran RFQ';
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-danger">
      ...
      <!-- /.box-header -->
      <div class="box-body">
        <p> Subjek Penawaran: Test Test Test</p>
        <p> Harga yang ditawarkan : 50 Ton</p>
        <p> Keterangan produk ditawarkan : Test Test Test</p>
      ...
      <div class="box-body">
        <button class="btn btn-success">Terima Penawaran</button>
      </div>
      <!-- /.box-body -->
    </div>
    <!--/.box -->
